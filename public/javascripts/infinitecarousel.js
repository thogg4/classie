	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				html = '<a href="javascript:void(0);"><img id="pause_btn'+randID+'" src="/js/infiniteCarousel/images/pause.png" style="position:absolute;top:3px;right:3px;border:none;color:transparent;" alt="Pause" /></a>';
				html += '<a href="javascript:void(0);"><img id="play_btn'+randID+'" src="/js/infiniteCarousel/images/play.png" style="position:absolute;top:3px;right:3px;border:none;display:none;color:transparent;" alt="Play" /></a>';
				$(obj).append(html);
				...
				function borderpatrol(elem)
				{
					...
					setTimeout(function(){elem.css({'background':'#777777'}).animate({'opacity': .99},500);},o.transitionSpeed);
				}
